---
title: Synapse Fleet Hub Architecture
---

# Synapse Fleet Hub Architecture

Synapse Fleet (formerly Signal Horizon) is a multi-tenant hub that ingests threat signals from Synapse sensors, correlates them into campaigns, and distributes intelligence to dashboards and the fleet.
...
graph LR
    ...
    subgraph Hub ["Synapse Fleet Hub"]
        API[API Server]
