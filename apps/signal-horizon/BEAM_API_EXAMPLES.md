...
This document provides example API requests and responses for the Beam Customer Protection Console endpoints.
...
```bash
GET /api/v1/beam/threats?limit=20&offset=0
```
