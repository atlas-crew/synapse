...
-- CreateIndex
CREATE UNIQUE INDEX "sensor_intel_actor_uq" ON "sensor_intel_actor"("tenantId", "sensorId", "actorId");

-- CreateIndex
CREATE INDEX "sensor_intel_actor_last_seen_idx" ON "sensor_intel_actor"("tenantId", "lastSeenAt" DESC);

-- CreateIndex
CREATE INDEX "sensor_intel_actor_sensor_idx" ON "sensor_intel_actor"("sensorId");

-- CreateIndex
CREATE UNIQUE INDEX "sensor_intel_session_uq" ON "sensor_intel_session"("tenantId", "sensorId", "sessionId");

-- CreateIndex
CREATE INDEX "sensor_intel_session_last_activity_idx" ON "sensor_intel_session"("tenantId", "lastActivityAt" DESC);

-- CreateIndex
CREATE INDEX "sensor_intel_session_sensor_idx" ON "sensor_intel_session"("sensorId");

-- CreateIndex
CREATE UNIQUE INDEX "sensor_intel_campaign_uq" ON "sensor_intel_campaign"("tenantId", "sensorId", "campaignId");

-- CreateIndex
CREATE INDEX "sensor_intel_campaign_last_activity_idx" ON "sensor_intel_campaign"("tenantId", "lastActivityAt" DESC);

-- CreateIndex
CREATE INDEX "sensor_intel_campaign_sensor_idx" ON "sensor_intel_campaign"("sensorId");

-- CreateIndex
CREATE UNIQUE INDEX "sensor_intel_profile_uq" ON "sensor_intel_profile"("tenantId", "sensorId", "template", "method");

-- CreateIndex
CREATE INDEX "sensor_intel_profile_updated_idx" ON "sensor_intel_profile"("tenantId", "updatedAt" DESC);

-- CreateIndex
CREATE INDEX "sensor_intel_profile_sensor_idx" ON "sensor_intel_profile"("sensorId");

-- CreateIndex
CREATE INDEX "sensor_payload_snapshot_recent_idx" ON "sensor_payload_snapshot"("tenantId", "capturedAt" DESC);

-- CreateIndex
CREATE INDEX "sensor_payload_snapshot_sensor_idx" ON "sensor_payload_snapshot"("sensorId");
