...
impl DetectionEngine {
    ...
    ///
    /// The timeout is clamped to 500ms because Synapse executes regex-heavy
    /// rules inline on the request path and higher limits materially increase
    /// ReDoS exposure during attacker-controlled traffic.
