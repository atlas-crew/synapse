...
use crate::horizon::{ThreatSignal, SignalSink};
use crate::intelligence::{SignalManager, SignalCategory};
...
impl SignalDispatcher {
    ...
    pub async fn dispatch(
        ...
        for sink in &self.sinks {
            ...
            sink_tasks.push(async move {
                sink_clone.report_signal(signal_clone).await
            });
        }
        ...
        if local_success {
            self.metrics.signal_dispatch_metrics().record_success(start.elapsed().as_micros() as u64);
